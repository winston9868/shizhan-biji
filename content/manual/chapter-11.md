...
id: chapter-11
num: "11"
title: 第 11 章 课外阅读：一章看懂 AI 工作系统
cat: WB手册
---

## 先看全景：一次 AI 任务里发生了什么

![AI 工作系统全景流程图](../images/ch11-01.png)
...
<figure class="wb-mermaid"><pre class="wb-mermaid__fallback"><code>flowchart TD
    A[接收目标] --> B[观察资料与状态]
    B --> C[规划下一步]
    C --> D[调用工具执行]
    D --> E[读取结果与错误]
...
知道什么时候停下来问人，比什么都自己硬扛更专业。一个不会停的 Agent，比一个笨 Agent 更危险。
...
知识库是 external 的资料室，模型用时才去翻，翻完不保证下次还记。
